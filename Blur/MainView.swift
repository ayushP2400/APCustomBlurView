...
class MainView: UIView {
    ...
    func configureSubviews() {
        // Add Subviews
        addSubviews(subviews: [imageView, blurView, blurSlider, blurButton])
        ...
        blurSlider.transform = CGAffineTransform(scaleX: 0.8, y: 0.8)
        
        blurButton.setTitle("Auto", for: .normal)
        blurButton.titleLabel?.font = .systemFont(ofSize: 20)
